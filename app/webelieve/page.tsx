...
export default function Page() {
    return (
        <div id="weBelievePage">
            <h2>What we believe</h2>
            <div id="whatWeBelieve">
                <img src="img/we-believe.webp" alt="As a church we believe: Injustice anywhere is a threat to justice everywhere. Love is love. Black lives matter. Science is real. Women's rights are human rights. No human is illegal. All genders are whole, holy & good. You are made in the image of God."/>
                <p>See below to read through our various positions on our Christian convictions to love as Jesus did. And our mission as a church to bring healing and restoration to the world as we are called to in partnership with the Holy Spirit&#39;s work. This is a continuous work and we will be adding to and updating this page regularly.</p>
            </div>
            <div id="beliefs">
                <h2>What we believe about the Bible</h2>
                ...
                <h2>Our Statement of Faith on Reparations</h2>
                ...
                <h2>We Welcome and Affirm the LGBT+ Community</h2>
