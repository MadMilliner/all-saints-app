...
export default function Page() {
    return (
        <div className="flex flex-col w-full py-8 gap-8">
            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-between items-center w-[90%] max-w-6xl mx-auto gap-8">
            ...
            <div className="flex flex-col w-full text-sm font-extralight gap-8">
                
                <div className="flex flex-col gap-4">
                    <h2 className="text-[1.2rem] font-medium text-left ml-[10%] self-start text-[var(--var-rnbw2)]">What we believe about the Bible</h2>
                    <p className="w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                ...
                <div className="flex flex-col gap-4">
                    <h2 className="text-[1.2rem] font-medium text-left ml-[10%] self-start text-[var(--var-rnbw2)]">The Apostle's Creed</h2>
                    <p className="w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                ...
                <div className="flex flex-col gap-4">
                    <h2 className="text-[1.2rem] font-medium text-left ml-[10%] self-start text-[var(--var-rnbw2)]">Our Statement of Faith on Reparations</h2>
                    <p className="w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                ...
                <div className="flex flex-col gap-4">
                    <h2 className="text-[1.2rem] font-medium text-left ml-[10%] self-start text-[var(--var-rnbw2)]">We Welcome and Affirm the LGBT+ Community</h2>
                    <p className="w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
