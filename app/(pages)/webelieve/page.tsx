...
export const generateMetadata = (): Metadata => {
  return{title: 'We Believe',}
}

export default function Page() {
    return (
        <div className="flex flex-col w-full py-8">
            <h2 className="text-2xl font-medium text-left ml-[10%] text-[var(--var-rnbw2)]">What we believe</h2>
            <div className="flex flex-col md:flex-row justify-center md:justify-between items-center w-[90%] max-w-6xl mx-auto my-8 gap-8">
                <img className="w-full max-w-[min(350px,25rem)] block object-scale-down" src="img/we-believe.webp" alt="As a church we believe: Injustice anywhere is a threat to justice everywhere. Love is love. Black lives matter. Science is real. Women's rights are human rights. No human is illegal. All genders are whole, holy & good. You are made in the image of God."/>
                <p className="w-full md:w-1/2 max-w-xl font-extralight text-center md:text-left">See below to read through our various positions on our Christian convictions to love as Jesus did. And our mission as a church to bring healing and restoration to the world as we are called to in partnership with the Holy Spirit&#39;s work. This is a continuous work and we will be adding to and updating this page regularly.</p>
            </div>
            <div className="flex flex-col my-8 w-full text-sm font-extralight">
                <h2 className="text-[1.2rem] font-medium text-left my-[3vh] ml-[10%] self-start text-[var(--var-rnbw2)]">What we believe about the Bible</h2>

                <p className="mb-[0.7rem] w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                    We believe the Bible points us toward liberation, and Jesus desires it to be good news for us, however we lament that it has too often been a tool of oppression. The Bible always has been and always will be an interpreted text. And as the flawed and limited humans that we are, we have been the only interpreters.
                    We recognize the church&#39;s history of not always getting it right. We value a holistic approach to understanding scripture through the life and teaching of Jesus. We seek to re-read scripture through the lens of the marginalized and oppressed.
                </p>

                <h2 className="text-[1.2rem] font-medium text-left my-[3vh] ml-[10%] self-start text-[var(--var-rnbw2)]">The Apostle's Creed</h2>
                ...
                <p className="mb-[0.7rem] w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                    ...
                    He ascended into heaven, and is seated at the right hand of God. He will come again to judge the living and the dead. We believe in the Holy Spirit, the Holy catholic Church, the communion of saints, the forgiveness of sins, the resurrection of the body, and the life everlasting. Amen.</p>

                <h2 className="text-[1.2rem] font-medium text-left my-[3vh] ml-[10%] self-start text-[var(--var-rnbw2)]">Our Statement of Faith on Reparations</h2>
                ...
                <p className="mb-[0.7rem] w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                    ...
                    As a Christ-centered and justice minded community striving toward inclusion and equity, we strive to work for reparations and reparative justice. This work starts with repentance—collectively and individually. 
                </p>
                <p className="mb-[0.7rem] w-[90%] max-w-[65vw] md:max-w-3xl self-center mx-auto">
                    It aligns with the prophets Isaiah and Zechariah&#39;s admonitions: “Woe to those who make unjust laws, those who issue oppressive decrees, to deprive the poor of their rights and withhold justice from the oppressed of my people….”; “Do not oppress the widow or the fatherless, the foreigner or the poor. Do not plot evil against each other.” (Is.10:2; Zech.7:10)
                ...
                <h2 className="text-[1.2rem] font-medium text-left my-[3vh] ml-[10%] self-start text-[var(--var-rnbw2)]">We Welcome and Affirm the LGBT+ Community</h2>
            ...
            <div className="py-4 px-8 mx-auto w-[90%] max-w-[50vw] md:max-w-2xl font-extralight text-center">
                ...
                <h5 className="pt-2 font-semibold">- Philippians 2: 2-4</h5>
            </div>
        </div>
);
    };